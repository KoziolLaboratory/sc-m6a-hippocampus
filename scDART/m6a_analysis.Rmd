...
```{r, echo = FALSE, warning=FALSE, message = FALSE, dev=c('png', 'pdf')}
cds_file <- "/GPFS/Magda_lab_temp/maitenat/scs_yth/6J-3M-2ws-V2-3-YTH/bullseye/2023/6J-3M-2ws-V2-3-YTH_edit-sites_bc_filtered_all_yth_filt-all.dist.measures.txt"
...
```{r, echo = FALSE, warning=FALSE, message = FALSE, dev=c('png', 'pdf')}
cds_file <- "~/scratch60/scs_yth/6J-3M-V2-3-mut/metaplotR/6J-3M-V2-3-mut_edit-sites_bc_filtered_no_apobec_wt.dist.measures.txt"
...
```{r, echo = FALSE, warning=FALSE, message = FALSE, dev=c('png', 'pdf')}
filename <- "/GPFS/Magda_lab_temp/maitenat/scs_yth/6J-3M-V2-3-mut/bullseye/2023/6J-3M-V2-3-mut_edit-sites_bc_filtered_all.bed"
...
write.table(genes_highedit_ythmut, "/home/Magda_lab/maitenat/DATA/scs_yth/code/genes_highedit_ythmut.txt", row.names = FALSE)
...
write.table(genes_highedit_yth, "/home/Magda_lab/maitenat/DATA/scs_yth/code/genes_highedit_yth.txt", row.names = FALSE)
