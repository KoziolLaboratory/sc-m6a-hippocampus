...
# Description:  Here we are filtering the results of running CIMS on bulk HEK293T reads
# #
...
snp_bedfile=/GPFS/Magda_lab_temp/maitenat/common_all_20180423_snps.bed
...
# Filter by m/k
awk "{if(\$11>=0.05) {print \$0}}" filt2.cims > "${samplename}_filtered.cims"
