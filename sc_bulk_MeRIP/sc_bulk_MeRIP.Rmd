...
Intersection of the genes captured by bulk dart-seq, single-cell dart-seq and MeRIP intersection. Note that for the MeRIP, 141 regions could not be annotated to a gene. 
